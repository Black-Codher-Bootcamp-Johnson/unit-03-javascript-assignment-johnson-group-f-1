...
// 1. **As a** developer, **I want to** deploy the changes made to the timeline, **so that** the timeline can be viewed publicly - COMPLETED
...
// NEXT - LOOP OVER THE ARRAY.
dates.forEach(function (date) {
    console.log(dates.title);
});
console.log(dates);